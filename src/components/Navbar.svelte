...
<div>
  ...
  <hr class="my-3 mx-auto w-48 h-1 bg-gray-600 rounded border-0 md:my-3">
  <ul class="block list-none text-center mt-3 text-white">
    <li class="relative inline m-5">
        <a href="https://rvlt.gg/bScHAYGx">Support Server</a>
    </li>
    <li class="relative inline m-5">
        <a href="https://github.com/Queaxtra/infvolt">Github</a>
    </li>
  </ul>
</div>